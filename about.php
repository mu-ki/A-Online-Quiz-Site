...
<h2 align="center" style="font-family:'typo'; color:white">About Mugunthan</h2>
...
<span href="#" data-target="#login" style="color:lightyellow">Organized by Muki InfoTech,Erode<br><br></span></div>
<div class="col-md-2 box">
<a href="feedback.php" style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')">Feedback</a></div>
<div class="col-md-2 box">
<span href="about.php" s style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')">About Author</span></div>
</div>
</body>
</html>
